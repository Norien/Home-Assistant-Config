...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Required(CONF_ACCOUNTS): [ACCOUNT_SCHEMA]
})
...
class SteamSensor(Entity):
    ...
    def __init__(self, account, steamod):
        ...
        self._account = account.get(CONF_ID)
        self._entity_id = account.get(CONF_ENTITY_ID)
        self.update()
    ...
    def entity_id(self):
        ...
        if self._entity_id != None:
        	return 'sensor.steam_{}'.format(self._entity_id)
        else:
